...
* defer loading game until user picks map.
* save the name of the game config user last loaded map with
* draw axis aligned bounds when fast face tool is active
* serialize layer enabled/disabled hidden/shown state
